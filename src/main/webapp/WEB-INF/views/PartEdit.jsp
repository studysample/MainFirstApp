...
<div class="row">
<div class="col-4"><label for="id">Part ID</label></div>
<div class="col-4"><form:input path="id" class="form-control" readonly="true" /></div>
...
<div class="col-4"><form:input path="note" class="form-control" /></div>
<div class="col-4"><!-- Error Message --></div>
</div>
